...
public enum UD_DEPENDENCY_LABELS {
	...
	, EXPL_PV(
			"expl:pv"
			,"expletive - reflexive clitic attached to inherently reflexive verb aka pronominal verb"
			, "for reflexive clitics attached to inherently reflexive verbs "
			,""
			, ""
			)
	, EXPL_PASS(
			"expl:pass"
			,"expletive - reflexive verb attached to transitive verb and acting as a voice marker (passive or mediopassive)"
			, "for reflexive clitics attached to inherently reflexive verbs "
			,""
			, ""
			)
	...
	public static UD_DEPENDENCY_LABELS forName(String name) {
		...
		return UD_DEPENDENCY_LABELS.TBD;
	}
