...
public enum RELATIONSHIP_TYPES {
	 ...
	 * @return a list of Relationship Types that are links, that is, are "REFERS_TO"
	 */
	 ...
	 * @return a filtered list of Relationship Types
	 */
	 ...
	 * @param topic the filter to apply
	 * @return list of filtered relationship types
	 */
