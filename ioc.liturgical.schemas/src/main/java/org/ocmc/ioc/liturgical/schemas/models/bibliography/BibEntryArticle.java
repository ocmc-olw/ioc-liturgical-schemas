...
public class BibEntryArticle extends BibliographyEntry {
	...
	private static String schema = BibEntryArticle.class.getSimpleName();
	private static double schemaVersion = 1.1;

	public BibEntryArticle(
			String library
			, String key
) {
		super(library, key, schema, schemaVersion, BIBTEX_ENTRY_TYPES.ARTICLE);
	...
	@Attributes(id="top", required = true, description = "journaltitle")
