...
public class BibEntryInproceedings extends BibliographyEntry {
	...
	private static String schema = BibEntryInproceedings.class.getSimpleName();
	private static double schemaVersion = 1.1;

	public BibEntryInproceedings(
			String library
			, String key
) {
		super(library, key, schema, schemaVersion, BIBTEX_ENTRY_TYPES.INPROCEEDINGS);
