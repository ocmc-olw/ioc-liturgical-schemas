 ...
 * <a href="http://www.comp.leeds.ac.uk/amalgam/tagsets/upenn.html">See this reference.</a>
 * @author mac002
 *
 */
public enum GRAMMAR_ABBREVIATIONS {
	 ...
	 * @return Entry the enum value for that keyname
	 */
	 ...
	 * @param name penn code to search for
	 * @return Entry enum value for that penn code
	 */
	...
	/**
	 * Find the Enum value for this penn code
	 * @param name penn code to find
	 * @return Entry enum value for that code
	 */
	 ...
	 * @param name wordnet code to search for
	 * @return Entry enum value for that code
	 */
