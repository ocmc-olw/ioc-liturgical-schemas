 ...
 *
 */
public class AbstractLDOM extends LTKLite  {
	...
	public AbstractLDOM(String source, String schema, double version) {
		super(
				Constants.LIBRARY_LITURGICAL_DOCUMENT_MODEL
				,Constants.TOPIC_LITURGICAL_DOCUMENT_MODEL
				, source
				, schema
				, version
				);
	...
	public AbstractLDOM(String source, String schema, double version, boolean printPretty) {
		super(
				Constants.LIBRARY_LITURGICAL_DOCUMENT_MODEL
				,Constants.TOPIC_LITURGICAL_DOCUMENT_MODEL
				, source
