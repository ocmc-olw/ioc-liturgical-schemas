...
public class IsoLangThreeToTwo {
	...
	/**
	 * Converts an ISO Three character language code to the equivalent two character if exists
	 * @param three character ISO language code
	 * @return the two character language code equivalent of the three character code
	 */
