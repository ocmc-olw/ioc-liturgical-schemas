...
public class BibEntrySuppbook extends BibliographyEntry {
	...
	private static String schema = BibEntrySuppbook.class.getSimpleName();
	private static double schemaVersion = 1.1;

	public BibEntrySuppbook(
			String library
			, String key
) {
		super(library, key, schema, schemaVersion, BIBTEX_ENTRY_TYPES.SUPPBOOK);
