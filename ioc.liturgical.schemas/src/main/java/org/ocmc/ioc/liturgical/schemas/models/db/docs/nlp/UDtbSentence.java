 ...
 *
 */
@Attributes(title = "Universal Dependency Treebank Sentence Text", description = "Properties for the text of a sentence from a Universal Dependency Treebank.")
public class UDtbSentence extends LTKDb {
	private static final Logger logger = LoggerFactory.getLogger(UDtbSentence.class);

	private static double serialVersion = 1.1;
	private static String schema = UDtbSentence.class.getSimpleName();
	private static TOPICS ontoTopic = TOPICS.UD_TREEBANK_SENTENCE;
