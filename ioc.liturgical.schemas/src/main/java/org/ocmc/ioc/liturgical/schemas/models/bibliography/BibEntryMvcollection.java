...
public class BibEntryMvcollection extends BibliographyEntry {
	...
	private static String schema = BibEntryMvcollection.class.getSimpleName();
	private static double schemaVersion = 1.1;

	public BibEntryMvcollection(
			String library
			, String key
) {
		super(library, key, schema, schemaVersion, BIBTEX_ENTRY_TYPES.MVCOLLECTION);
