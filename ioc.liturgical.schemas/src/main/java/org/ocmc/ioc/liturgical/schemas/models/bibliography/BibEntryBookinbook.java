...
public class BibEntryBookinbook extends BibliographyEntry {
	...
	private static String schema = BibEntryBookinbook.class.getSimpleName();
	private static double schemaVersion = 1.1;

	public BibEntryBookinbook(
			String library
			, String key
) {
		super(library, key, schema, schemaVersion, BIBTEX_ENTRY_TYPES.BOOKINBOOK);
...
public String toBibtex() {
		...
		sb.append(keyValue("bookauthor", this.bookauthor));
