...
public class BibEntryMvreference extends BibliographyEntry {
	...
	private static String schema = BibEntryMvreference.class.getSimpleName();
	private static double schemaVersion = 1.1;

	public BibEntryMvreference(
			String library
			, String key
) {
		super(library, key, schema, schemaVersion, BIBTEX_ENTRY_TYPES.MVREFERENCE);
