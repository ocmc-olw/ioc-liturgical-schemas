...
public class BibEntryCollection extends BibliographyEntry {
	...
	private static String schema = BibEntryCollection.class.getSimpleName();
	private static double schemaVersion = 1.1;

	public BibEntryCollection(
			String library
			, String key
) {
		super(library, key, schema, schemaVersion, BIBTEX_ENTRY_TYPES.COLLECTION);
