...
public class BibEntryReference extends BibliographyEntry {
	...
	private static String schema = BibEntryReference.class.getSimpleName();
	private static double schemaVersion = 1.1;

	public BibEntryReference(
			String library
			, String key
) {
		super(library, key, schema, schemaVersion, BIBTEX_ENTRY_TYPES.REFERENCE);
