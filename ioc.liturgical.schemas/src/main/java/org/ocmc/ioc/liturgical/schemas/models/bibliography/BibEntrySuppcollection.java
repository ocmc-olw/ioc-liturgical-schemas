...
public class BibEntrySuppcollection extends BibliographyEntry {
	...
	private static String schema = BibEntrySuppcollection.class.getSimpleName();
	private static double schemaVersion = 1.1;

	public BibEntrySuppcollection(
			String library
			, String key
) {
		super(library, key, schema, schemaVersion, BIBTEX_ENTRY_TYPES.SUPPCOLLECTION);
