...
public class BibEntryIncollection extends BibliographyEntry {
	...
	private static String schema = BibEntryIncollection.class.getSimpleName();
	private static double schemaVersion = 1.1;

	public BibEntryIncollection(
			String library
			, String key
) {
		super(library, key, schema, schemaVersion, BIBTEX_ENTRY_TYPES.INCOLLECTION);
